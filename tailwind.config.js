  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-green': '0 0 20px rgba(200, 255, 0, 0.3), 0 0 40px rgba(200, 255, 0, 0.2)',
        'glow-white': '0 0 20px rgba(232, 244, 255, 0.3), 0 0 40px rgba(232, 244, 255, 0.2)',
        'glow-strong': '0 0 30px rgba(200, 255, 0, 0.4), 0 0 60px rgba(200, 255, 0, 0.3)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      transitionTimingFunction: {
        ...
        'fluid-motion': 'cubic-bezier(0.4, 0, 0, 1)',
      },
    },
  },
